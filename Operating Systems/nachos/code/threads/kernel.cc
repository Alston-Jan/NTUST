...
ThreadedKernel::ThreadedKernel(int argc, char **argv)
{
	...
	//cout<<"kernel.h constructor"<<endl;
    for (int i = 1; i < argc; i++) {
	    ...
	    i++;
            ...
            //cout<<"kernel.h RR"<<endl;
            type = RR;
        } else if (strcmp(argv[i], "FCFS") == 0) {
            //cout<<"kernel.h FIFO"<<endl;
            type = FIFO;
        } else if (strcmp(argv[i], "PRIORITY") == 0) {
            //cout<<"kernel.h Priority"<<endl;
            type = Priority;
        } else if (strcmp(argv[i], "SJF") == 0) {
            //cout<<"kernel.h SJF"<<endl;
			type = SJF;
        }
    }
}
